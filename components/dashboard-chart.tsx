...
export function DashboardChart({ data12months }: DashboardChartProps) {
    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-h2">Fluxo Financeiro (BRL)</CardTitle>
        ...
        {data.every(d => d.entradas === 0 && d.saidas === 0) ? (
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 0 }}>
              ...
              <YAxis tick={{ fontSize: 11, fill: '#6b8c6b' }} axisLine={false} tickLine={false} tickFormatter={v => `R$${(v/1000).toFixed(0)}k`} />
              <Tooltip
              ...
              <Area type="monotone" dataKey="entradas" stroke="#1e6b40" strokeWidth={2} fill="url(#gradEntradas)" />
